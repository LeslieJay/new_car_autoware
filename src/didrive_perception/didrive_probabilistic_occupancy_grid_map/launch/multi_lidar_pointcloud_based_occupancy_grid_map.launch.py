...
def launch_setup(context, *args, **kwargs):
    ...
    for i in range(number_of_nodes):
        ...
        node = ComposableNode(
            package="didrive_probabilistic_occupancy_grid_map",
            plugin="didrive::occupancy_grid_map::PointcloudBasedOccupancyGridMapNode",
    ...
    gridmap_fusion_node = [
        ComposableNode(
            package="didrive_probabilistic_occupancy_grid_map",
            plugin="didrive::occupancy_grid_map::GridMapFusionNode",
    ...
    return LaunchDescription(
        [
            ...
            add_launch_arg(
                ...
                get_package_share_directory("didrive_probabilistic_occupancy_grid_map")
