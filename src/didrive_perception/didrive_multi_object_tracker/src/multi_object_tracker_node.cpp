...
#include "didrive/multi_object_tracker/uncertainty/uncertainty_processor.hpp"
  ...
  const DetectedObjects & input_objects, const uint & channel_index)
{
  ...
  // // 赋值给 boost::optional
  // boost::optional<geometry_msgs::msg::Transform> self_transform = transform;
  ...
  // transformed_objects = input_objects_with_uncertainty;
  /* prediction */
...
RCLCPP_COMPONENTS_REGISTER_NODE(didrive::multi_object_tracker::MultiObjectTracker)
