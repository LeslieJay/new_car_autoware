...
#ifndef DIDRIVE__MULTI_OBJECT_TRACKER__TRACKER__MOTION_MODEL__CV_MOTION_MODEL_HPP_
#define DIDRIVE__MULTI_OBJECT_TRACKER__TRACKER__MOTION_MODEL__CV_MOTION_MODEL_HPP_

#include "autoware/kalman_filter/kalman_filter.hpp"
#include "didrive/multi_object_tracker/tracker/motion_model/motion_model_base.hpp"
...
public:
  ...
  const char DIM = 4;
  // mutable Eigen::Matrix<double, DIM, 1> X_t_;
  // mutable Eigen::Matrix<double, DIM, 1> X_next_t_;
  // mutable Eigen::Matrix<double, DIM, DIM> A_;
  // mutable Eigen::Matrix<double, DIM, DIM> Q_;
...
#endif  // DIDRIVE__MULTI_OBJECT_TRACKER__TRACKER__MOTION_MODEL__CV_MOTION_MODEL_HPP_
