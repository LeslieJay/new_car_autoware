...
TEST(VoxelGridBasedEuclideanClusterTest, testcase1)
{
  ...
  std::shared_ptr<didrive::euclidean_cluster::VoxelGridBasedEuclideanCluster> cluster_;
  float tolerance = 0.7;
  ...
  cluster_ = std::make_shared<didrive::euclidean_cluster::VoxelGridBasedEuclideanCluster>(
