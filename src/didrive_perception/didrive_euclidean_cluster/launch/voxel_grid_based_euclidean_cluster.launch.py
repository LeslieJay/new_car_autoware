...
def launch_setup(context, *args, **kwargs):
    ...
    ns = ""
    pkg = "didrive_euclidean_cluster"

    # 聚类节点配置
    euclidean_component = ComposableNode(
        package=pkg,
        plugin="didrive::euclidean_cluster::VoxelGridBasedEuclideanClusterNode",
        name="euclidean_cluster",
        remappings=[
            ("input", LaunchConfiguration("input_pointcloud")),
            ("output", LaunchConfiguration("output_clusters")),
        ],
        parameters=[load_composable_node_param("voxel_grid_based_euclidean_param_path", context)],
    )
    ...
    loader = LoadComposableNodes(
        composable_node_descriptions=[euclidean_component],
    ...
    return launch.LaunchDescription(
        [
            ...
            add_launch_arg(
                ...
                [
                    FindPackageShare("didrive_euclidean_cluster"),
