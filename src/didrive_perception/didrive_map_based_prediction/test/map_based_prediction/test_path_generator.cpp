...
TEST(PathGenerator, test_generatePathForNonVehicleObject)
{
  ...
  const didrive::map_based_prediction::PathGenerator path_generator =
    didrive::map_based_prediction::PathGenerator(
...
TEST(PathGenerator, test_generatePathForOnLaneVehicle)
{
  ...
  didrive::map_based_prediction::PosePath ref_paths;
...
TEST(PathGenerator, test_generatePathForCrosswalkUser)
{
  ...
  didrive::map_based_prediction::CrosswalkEdgePoints reachable_crosswalk;
