...
# 绕障必须话题
ros2 bag record -e "^/(planning|control|vehicle|external|sensing|rslidar)($|/)|^/localization/kinematic_state$|^/perception/object_recognition/objects$|^/perception/occupancy_grid_map/map$|^/map/vector_map$|^/localization/acceleration$|^/tf$|^/tf_static$" -o ~/autoware/log/0626/01_bag/