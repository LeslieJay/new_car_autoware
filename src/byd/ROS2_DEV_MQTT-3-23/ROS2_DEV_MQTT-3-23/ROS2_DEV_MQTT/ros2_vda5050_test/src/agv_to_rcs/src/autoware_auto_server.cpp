...
private:
    ...
    void execute(const std::shared_ptr<GoalHandle> goal_handle)
    {
        ...
        if (forward) {
            ...
            RCLCPP_INFO(this->get_logger(), "前往新的前进目标点.");
        } else {
...
// ros2 topic pub --once /uagv/v1/BYD/qqa0001/order vda5050_interfaces/msg/AGVOrder "{header_id: 1, timestamp: '2026-07-15T16:25:21.598575+08:00', version: v1, manufacturer: BYD, serial_number: qqa0001, order_id: 'task-p2p-20260715-33YQ', order_update_id: 0, zone_set_id: map_floor_1, nodes: [{node_id: '2#前段卸料点', sequence_id: 0, released: true, node_position: {x: 288.446258544922, y: -129.203323364258, theta: -2.63259410858154, map_id: '', map_description: '', allowed_deviation_xy: 0.5, allowed_deviation_theta: 5.0}, actions: [{action_type: pick, action_id: 'pick-action-001', action_description: '', blocking_type: HARD, action_parameters: [{key: height, value: {array_value: [], boolean_value: false, number_value: 1.0, string_value: ''}}]}]}, {node_id: '2#前段卸料点', sequence_id: 2, released: true, node_position: {x: 288.446258544922, y: -129.203323364258, theta: -2.63259410858154, map_id: '', map_description: '', allowed_deviation_xy: 0.5, allowed_deviation_theta: 5.0}, actions: [{action_type: pick, action_id: 'pick-action-001', action_description: '', blocking_type: HARD, action_parameters: [{key: height, value: {array_value: [], boolean_value: false, number_value: 1.0, string_value: ''}}]}]}], edges: [{edge_id: 'edge_01_2#前段卸料点', sequence_id: 1, edge_description: '', released: true, start_node_id: '01', end_node_id: '2#前段卸料点', max_speed: 1.0, max_height: 0.0, orientation: 0.0, orientation_type: TANGENTIAL, direction: '', rotation_allowed: false, max_rotation_speed: 0.0, length: 0.0, obstacle_avoidance_channel: 0, trajectory: {degree: 1, knot_vector: [], control_points: []}, actions: []}]}"
// ros2 topic pub --once /uagv/v1/BYD/qqa0001/order vda5050_interfaces/msg/AGVOrder "{header_id: 1, timestamp: '2026-07-15T16:27:46.909346+08:00', version: v1, manufacturer: BYD, serial_number: qqa0001, order_id: 'task-p2p-20260715-EL05', order_update_id: 0, zone_set_id: map_floor_1, nodes: [{node_id: '2#后段卸料点', sequence_id: 0, released: true, node_position: {x: 167.678558349609, y: -194.128631591797, theta: -2.69616770744324, map_id: '', map_description: '', allowed_deviation_xy: 0.5, allowed_deviation_theta: 5.0}, actions: [{action_type: , action_id: 'pick-action-001', action_description: '', blocking_type: , action_parameters: [{key: height, value: {array_value: [], boolean_value: false, number_value: 1.0, string_value: ''}}]}]}, {node_id: '2#后段卸料点', sequence_id: 2, released: true, node_position: {x: 167.678558349609, y: -194.128631591797, theta: -2.69616770744324, map_id: '', map_description: '', allowed_deviation_xy: 0.5, allowed_deviation_theta: 5.0}, actions: [{action_type: LOAD, action_id: 'pick-action-001', action_description: '', blocking_type: HARD, action_parameters: [{key: height, value: {array_value: [], boolean_value: false, number_value: 1.0, string_value: ''}}]}]}], edges: [{edge_id: 'edge_01_2#后段卸料点', sequence_id: 1, edge_description: '', released: true, start_node_id: '01', end_node_id: '2#后段卸料点', max_speed: 1.0, max_height: 0.0, orientation: 0.0, orientation_type: TANGENTIAL, direction: '', rotation_allowed: false, max_rotation_speed: 0.0, length: 0.0, obstacle_avoidance_channel: 0, trajectory: {degree: 1, knot_vector: [], control_points: []}, actions: []}]}"
